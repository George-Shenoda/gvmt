            ...
            <div key={index} className="col-span-1">
                <Card>
                    ...
                    <CardFooter className="flex justify-between">
                        <Button
                            className={`w-full ${item.available - item.ordered > 0 || item.ordered === item.max ? "cursor-pointer" : "cursor-not-allowed"}`}
                            disabled={
                                item.available - item.ordered <= 0 ||
                                item.ordered === item.max
                            }
                            onClick={onClick}
                        >
                            Add to cart
